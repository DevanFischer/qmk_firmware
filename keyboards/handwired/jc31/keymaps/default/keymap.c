...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [ABC1] = KEYMAP(
    _______, KC_HOME, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_END,
    KC_ESC,  KC_P,    KC_W,    KC_R,    KC_A,    KC_F,    KC_BSPC,
    LT_SPAC, KC_D,    KC_T,    KC_H,    KC_E,    KC_O,    KC_DELT,
    OS_SFT,  KC_Y,    KC_S,    KC_N,    KC_I,    KC_U,    LT_SPAC,
             KC_ENT,           LT_NUMB,          LT_SYMB
  ),
  [ABC2] = KEYMAP(
    _______, M_LCHM,  M_LCLF,  M_LCDN,  M_LCUP,  M_LCRG,  M_LCED,
    _______, KC_J,    KC_M,    KC_B,    KC_QUOT, KC_TAB,  M_LCBSP,
    _______, KC_V,    KC_C,    KC_L,    KC_Z,    KC_Q,    M_LCDEL,
    _______, KC_X,    KC_G,    KC_K,    XXXXXXX, KC_LALT, _______,
             KC_DOT,           KC_COMM,          KC_0
  ),
  [SYM1] = KEYMAP(
    _______, _______, _______, _______, _______, _______, _______,
