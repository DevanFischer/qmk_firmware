...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_QWERT] = KEYMAP(
    ...
    KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_UP,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,
             KC_LCTL, KC_LALT,          MK_CONF, KC_SPC,  KC_LEFT, KC_DOWN, KC_RGHT, KC_ENT,  XXXXXXX,          KC_RALT, KC_RCTL
  ),
  [L_DVORK] = KEYMAP(
    _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______,
  ...
  [L_MODDH] = KEYMAP(
    ...
    _______, _______, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,             KC_K,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT, KC_BSLS,
    _______,          KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    _______, KC_M,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,
             _______, _______,          _______, _______, _______, _______, _______, _______, _______,          _______, _______
  ),
  [L_CONFG] = KEYMAP(
    ...
    _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______,
    TOGINVT,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          TOGINVT,
    _______, _______,          _______, _______, _______, _______, _______, _______, _______,          _______, _______
  ),
};
