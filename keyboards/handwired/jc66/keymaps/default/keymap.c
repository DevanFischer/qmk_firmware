...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_QWERT] = KEYMAP(
    ...
    KC_HOME, KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,             KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    MK_LBRC, KC_RBRC,
    KC_END,  KC_BSPC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_BSLS,
    KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_UP,   KC_N,    KC_M,    MK_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,
             KC_LCTL, KC_LALT,          MK_CONF, KC_SPC,  KC_LEFT, KC_DOWN, KC_RGHT, MK_ENT,  MK_CONF,          KC_RALT, KC_RCTL
  ),
  [L_DVORK] = KEYMAP(
    _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______,
  ...
  [L_MODDH] = KEYMAP(
    ...
    _______, _______, KC_A,    KC_R,    KC_S,    KC_T,    MK_G,             MK_K,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT, KC_BSLS,
    _______,          KC_Z,    KC_X,    KC_C,    KC_D,    MK_V,    _______, MK_M,    KC_H,    MK_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,
             _______, _______,          _______, _______, _______, _______, _______, _______, _______,          _______, _______
  ),
  [L_CONFG] = KEYMAP(
    _______, _______, QWERT,   DVORK,   COLMK,   MODDH,   _______,          _______, _______, _______, _______, _______, _______, _______,
    KC_PGUP, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______,          _______, _______, _______, _______, _______, _______, _______,
    KC_PGDN, KC_DELT, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,          _______, _______, _______, _______, _______, _______, _______,
    TOGINVT,          _______, _______, _______, _______, _______, MK_WUP,  _______, _______, _______, _______, _______,          TOGINVT,
             _______, _______,          _______, _______, MK_WLF,  MK_WDN,  MK_WRT,  _______, _______,          _______, _______
  ),
};
